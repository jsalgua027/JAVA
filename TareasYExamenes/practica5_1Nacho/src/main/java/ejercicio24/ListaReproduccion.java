...
public class ListaReproduccion {
    ...
    public void ordenarComparator(Cancion c){
        Collections.binarySearch(listaReproduccion, c, (Cancion aux1,Cancion aux2)->aux1.getEstilo().compareTo(aux2.getEstilo()));
